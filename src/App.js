...
import StudentLessons from "./pages/StudentLessons"; // Import StudentLessons component
...
function App() {
  ...
  const renderStudentRoutes = userRole === "Student" ? (
    <>
      ...
      <Route path="/StudentLessons" element={<StudentLessons />} /> {/* Add route for StudentLessons */}
    </>
  ) : null;
